    ...
    private static void wsMessage(String response) {
        ...
        switch (msgObj.getString("type")) {
            ...
            case "serverMouseMoving":
                JSONObject positions = msgObj.getJSONObject("positions");
                if (positions.has(clientId)) {
                    JSONObject clientPosition = positions.getJSONObject(clientId);
                    ctrlPlay.setPlayersMousePositions(clientPosition);
                }
                break;
            case "serverSelectableObjects":
                JSONObject selectableObjects = msgObj.getJSONObject("selectableObjects");
                if (selectableObjects.has(clientId)) {
                    JSONObject clientObjects = selectableObjects.getJSONObject(clientId);
                    ctrlPlay.setSelectableObjects(clientObjects);
                }
                break;
        }
    }
